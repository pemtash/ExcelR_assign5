########################## STARTUPS ###################################
Startups <- read.csv("C:\\Users\\user\\Desktop\\EXCELR ASSIGNMENT\\ASSIGNMENT\\assignment5_multilinear_regression\\50_Startups.csv")
View(Startups)
attach(Startups)
summary(Startups) # we will know the min, max, mean and median of this startups
head(Startups)

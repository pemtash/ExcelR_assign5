ToyotaCorolla <- read.csv("C:\\Users\\user\\Desktop\\EXCELR ASSIGNMENT\\ASSIGNMENT\\assignment5_multilinear_regression\\ToyotaCorolla.csv")
View(ToyotaCorolla)
...
plot(Doors,Price)
plot(Gears,Price)
plot(Quarterly_Tax,log(Price)) # we use log transformation to reduce the numbers
